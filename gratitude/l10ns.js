export function getLocalizations( lang ) {
	const l10ns = { en: { bannerTitleQuestion: 'Learn about wikipedia. this is going to be a lot of text, align automatically.', bannerSubtitleAsk: 'CivilServant presents', bannerButtonNext: 'click here to learn more→', bannerDir: 'ltr' },
